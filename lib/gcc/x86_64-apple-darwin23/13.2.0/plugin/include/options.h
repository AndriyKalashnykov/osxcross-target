...
enum opt_code
{
  ...
  OPT_foffload_abi_ = 1471,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1472,              /* -foffload-options= */
  OPT_foffload_ = 1473,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1474,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1475,                         /* -fonly= */
  OPT_fopenacc = 1476,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1477,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1478,                        /* -fopenmp */
  OPT_fopenmp_simd = 1479,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1480, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1481,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1482,                /* -foperator-names */
  OPT_fopt_info = 1483,                      /* -fopt-info */
  OPT_fopt_info_ = 1484,                     /* -fopt-info- */
  /* OPT_foptimize_register_move = 1485, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1486,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1487,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1488, */          /* -foptional-diags */
  OPT_force_cpusubtype_ALL = 1489,           /* -force_cpusubtype_ALL */
  OPT_force_flat_namespace = 1490,           /* -force_flat_namespace */
  OPT_fpack_derived = 1491,                  /* -fpack-derived */
  OPT_fpack_struct = 1492,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1493,                  /* -fpack-struct= */
  OPT_fpad_source = 1494,                    /* -fpad-source */
  OPT_fpartial_inlining = 1495,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1496,     /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 1497,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1498,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1499,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1500,                    /* -fpeel-loops */
  OPT_fpeephole = 1501,                      /* -fpeephole */
  OPT_fpeephole2 = 1502,                     /* -fpeephole2 */
  OPT_fpermissive = 1503,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1504,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1505,                           /* -fpic */
  OPT_fpie = 1506,                           /* -fpie */
  OPT_fpim = 1507,                           /* -fpim */
  OPT_fpim2 = 1508,                          /* -fpim2 */
  OPT_fpim3 = 1509,                          /* -fpim3 */
  OPT_fpim4 = 1510,                          /* -fpim4 */
  OPT_fplan9_extensions = 1511,              /* -fplan9-extensions */
  OPT_fplt = 1512,                           /* -fplt */
  OPT_fplugin_arg_ = 1513,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1514,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1515,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1516,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1517,                /* -fpostconditions */
  OPT_fpre_include_ = 1518,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1519,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1520,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1521,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1522,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1523,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1524,              /* -fpretty-templates */
  OPT_fpreview_all = 1525,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1526,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1527,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1528,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1529,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1530,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1531,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1532,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1533,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1534,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1535,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1536,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1537,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_systemvariables = 1538,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1539,           /* -fprintf-return-value */
  OPT_fprofile = 1540,                       /* -fprofile */
  OPT_fprofile_abs_path = 1541,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1542,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1543,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1544,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1545,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1546,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1547,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1548,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1549,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1550,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1551,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1552,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1553,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1554,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1555,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1556,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1557,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1558,               /* -fprofile-update= */
  OPT_fprofile_use = 1559,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1560,                  /* -fprofile-use= */
  OPT_fprofile_values = 1561,                /* -fprofile-values */
  OPT_fprotect_parens = 1562,                /* -fprotect-parens */
  OPT_fpthread = 1563,                       /* -fpthread */
  OPT_fq = 1564,                             /* -fq */
  OPT_framework = 1565,                      /* -framework */
  OPT_frandom_seed = 1566,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1567,                  /* -frandom-seed= */
  OPT_frange = 1568,                         /* -frange */
  OPT_frange_check = 1569,                   /* -frange-check */
  OPT_freal_4_real_10 = 1570,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1571,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1572,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1573,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1574,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1575,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1576,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1577,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1578,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1579,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1580,               /* -frecord-marker=8 */
  OPT_frecursive = 1581,                     /* -frecursive */
  OPT_free = 1582,                           /* -free */
  OPT_freg_struct_return = 1583,             /* -freg-struct-return */
  /* OPT_fregmove = 1584, */                 /* -fregmove */
  OPT_frelease = 1585,                       /* -frelease */
  OPT_frename_registers = 1586,              /* -frename-registers */
  OPT_freorder_blocks = 1587,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1588,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1589,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1590,             /* -freorder-functions */
  OPT_frepack_arrays = 1591,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1592,          /* -freplace-objc-classes */
  OPT_frepo = 1593,                          /* -frepo */
  OPT_freport_bug = 1594,                    /* -freport-bug */
  OPT_frequire_return_statement = 1595,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1596,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1597, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1598,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1599,                   /* -fresolution= */
  OPT_freturn = 1600,                        /* -freturn */
  OPT_frevert_all = 1601,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1602,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1603,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1604,             /* -frevert=intpromote */
  OPT_frounding_math = 1605,                 /* -frounding-math */
  OPT_frtti = 1606,                          /* -frtti */
  OPT_fruntime_modules_ = 1607,              /* -fruntime-modules= */
  OPT_frust_cfg_ = 1608,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1609,           /* -frust-compile-until= */
  OPT_frust_crate_ = 1610,                   /* -frust-crate= */
  OPT_frust_debug = 1611,                    /* -frust-debug */
  OPT_frust_dump_ = 1612,                    /* -frust-dump- */
  OPT_frust_edition_ = 1613,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1614,           /* -frust-embed-metadata */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1615,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1616,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1617,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1618,         /* -frust-metadata-output= */
  OPT_fsanitize_address_use_after_scope = 1619,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1620,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1621,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1622,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1623,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1624,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1625,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1626, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1627,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1628,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1629,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1630,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1631,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1632,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1633,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1634,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1635, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1636,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1637,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1638,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1639,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1640,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1641,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1642,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1643,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1644,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1645,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1646,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1647,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1648,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1649,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1650,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1651,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1652, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1653,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1654,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1655,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1656,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1657,               /* -fsection-anchors */
  /* OPT_fsee = 1658, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1659,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1660,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1661,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1662,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1663,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1664,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1665,        /* -fsemantic-interposition */
  OPT_fshared = 1666,                        /* -fshared */
  OPT_fshort_enums = 1667,                   /* -fshort-enums */
  OPT_fshort_wchar = 1668,                   /* -fshort-wchar */
  OPT_fshow_column = 1669,                   /* -fshow-column */
  OPT_fshrink_wrap = 1670,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1671,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1672,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1673,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1674,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1675,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1676,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1677,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1678,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1679,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1680,                /* -fsoft-check-all */
  OPT_fsources = 1681,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1682,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1683,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1684,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1685,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1686,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1687,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1688,                      /* -fsquangle */
  OPT_fssa_backprop = 1689,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1690,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1691,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1692,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1693, */             /* -fstack-check */
  OPT_fstack_check_ = 1694,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1695,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1696,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1697,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1698,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1699,               /* -fstack-protector */
  OPT_fstack_protector_all = 1700,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1701,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1702,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1703,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1704,                   /* -fstack-usage */
  OPT_fstats = 1705,                         /* -fstats */
  OPT_fstdarg_opt = 1706,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1707,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1708, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1709,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1710,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1711, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1712,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1713,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1714,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1715,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1716, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1717,            /* -fstrong-eval-order= */
  OPT_fswig = 1718,                          /* -fswig */
  OPT_fswitch_errors = 1719,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1720,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1721,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1722,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1723, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1724,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1725, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1726,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1727, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1728,               /* -ftemplate-depth= */
  OPT_fterminated_vtables = 1729,            /* -fterminated-vtables */
  ...
  OPT_gbtf = 1862,                           /* -gbtf */
  OPT_gcoff = 1863,                          /* -gcoff */
  OPT_gcoff1 = 1864,                         /* -gcoff1 */
  OPT_gcoff2 = 1865,                         /* -gcoff2 */
  OPT_gcoff3 = 1866,                         /* -gcoff3 */
  OPT_gcolumn_info = 1867,                   /* -gcolumn-info */
  OPT_gctf = 1868,                           /* -gctf */
  OPT_gdescribe_dies = 1869,                 /* -gdescribe-dies */
  OPT_gdwarf = 1870,                         /* -gdwarf */
  OPT_gdwarf_ = 1871,                        /* -gdwarf- */
  OPT_gdwarf32 = 1872,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1873,                       /* -gdwarf64 */
  OPT_gen_decls = 1874,                      /* -gen-decls */
  OPT_gfull = 1875,                          /* -gfull */
  OPT_ggdb = 1876,                           /* -ggdb */
  ...
  OPT_gused = 1893,                          /* -gused */
  OPT_gvariable_location_views = 1894,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1895,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1896,                           /* -gvms */
  OPT_gxcoff = 1897,                         /* -gxcoff */
  OPT_gxcoff_ = 1898,                        /* -gxcoff+ */
  OPT_gz = 1899,                             /* -gz */
  OPT_gz_ = 1900,                            /* -gz= */
  OPT_h = 1901,                              /* -h */
  OPT_headerpad_max_install_names = 1902,    /* -headerpad_max_install_names */
  OPT_help = 1903,                           /* -help */
  OPT_idirafter = 1904,                      /* -idirafter */
  OPT_iframework = 1905,                     /* -iframework */
  OPT_imacros = 1906,                        /* -imacros */
  OPT_image_base = 1907,                     /* -image_base */
  OPT_imultiarch = 1908,                     /* -imultiarch */
  OPT_imultilib = 1909,                      /* -imultilib */
  OPT_include = 1910,                        /* -include */
  OPT_init = 1911,                           /* -init */
  OPT_install_name = 1912,                   /* -install_name */
  OPT_iplugindir_ = 1913,                    /* -iplugindir= */
  OPT_iprefix = 1914,                        /* -iprefix */
  OPT_iquote = 1915,                         /* -iquote */
  OPT_isysroot = 1916,                       /* -isysroot */
  OPT_isystem = 1917,                        /* -isystem */
  OPT_iwithprefix = 1918,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1919,              /* -iwithprefixbefore */
  OPT_k8 = 1920,                             /* -k8 */
  OPT_keep_private_externs = 1921,           /* -keep_private_externs */
  OPT_l = 1922,                              /* -l */
  OPT_lang_asm = 1923,                       /* -lang-asm */
  OPT_list = 1924,                           /* -list */
  OPT_m128bit_long_double = 1925,            /* -m128bit-long-double */
  OPT_m16 = 1926,                            /* -m16 */
  OPT_m32 = 1927,                            /* -m32 */
  OPT_m3dnow = 1928,                         /* -m3dnow */
  OPT_m3dnowa = 1929,                        /* -m3dnowa */
  OPT_m64 = 1930,                            /* -m64 */
  OPT_m80387 = 1931,                         /* -m80387 */
  OPT_m8bit_idiv = 1932,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1933,             /* -m96bit-long-double */
  OPT_mabi_ = 1934,                          /* -mabi= */
  OPT_mabm = 1935,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1936,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1937,                 /* -maddress-mode= */
  OPT_madx = 1938,                           /* -madx */
  OPT_maes = 1939,                           /* -maes */
  OPT_malign_data_ = 1940,                   /* -malign-data= */
  OPT_malign_double = 1941,                  /* -malign-double */
  OPT_malign_functions_ = 1942,              /* -malign-functions= */
  OPT_malign_jumps_ = 1943,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1944,                  /* -malign-loops= */
  OPT_malign_stringops = 1945,               /* -malign-stringops */
  OPT_mamx_bf16 = 1946,                      /* -mamx-bf16 */
  OPT_mamx_complex = 1947,                   /* -mamx-complex */
  OPT_mamx_fp16 = 1948,                      /* -mamx-fp16 */
  OPT_mamx_int8 = 1949,                      /* -mamx-int8 */
  OPT_mamx_tile = 1950,                      /* -mamx-tile */
  OPT_march_ = 1951,                         /* -march= */
  OPT_masm_ = 1952,                          /* -masm= */
  OPT_matt_stubs = 1953,                     /* -matt-stubs */
  OPT_mavx = 1954,                           /* -mavx */
  OPT_mavx2 = 1955,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1956,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1957,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1958,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1959,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1960,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1961,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1962,                      /* -mavx512bw */
  OPT_mavx512cd = 1963,                      /* -mavx512cd */
  OPT_mavx512dq = 1964,                      /* -mavx512dq */
  OPT_mavx512er = 1965,                      /* -mavx512er */
  OPT_mavx512f = 1966,                       /* -mavx512f */
  OPT_mavx512fp16 = 1967,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1968,                    /* -mavx512ifma */
  OPT_mavx512pf = 1969,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1970,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1971,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1972,                      /* -mavx512vl */
  OPT_mavx512vnni = 1973,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1974,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1975,               /* -mavx512vpopcntdq */
  OPT_mavxifma = 1976,                       /* -mavxifma */
  OPT_mavxneconvert = 1977,                  /* -mavxneconvert */
  OPT_mavxvnni = 1978,                       /* -mavxvnni */
  OPT_mavxvnniint8 = 1979,                   /* -mavxvnniint8 */
  OPT_mbmi = 1980,                           /* -mbmi */
  OPT_mbmi2 = 1981,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1982,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1983,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1984,                    /* -mcet-switch */
  OPT_mcld = 1985,                           /* -mcld */
  OPT_mcldemote = 1986,                      /* -mcldemote */
  OPT_mclflushopt = 1987,                    /* -mclflushopt */
  OPT_mclwb = 1988,                          /* -mclwb */
  OPT_mclzero = 1989,                        /* -mclzero */
  OPT_mcmodel_ = 1990,                       /* -mcmodel= */
  OPT_mcmpccxadd = 1991,                     /* -mcmpccxadd */
  OPT_mconstant_cfstrings = 1992,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1993, */                    /* -mcpu= */
  OPT_mcrc32 = 1994,                         /* -mcrc32 */
  OPT_mcx16 = 1995,                          /* -mcx16 */
  OPT_mdaz_ftz = 1996,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 1997,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 1998,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1999,            /* -mdump-tune-features */
  OPT_mdynamic_no_pic = 2000,                /* -mdynamic-no-pic */
  OPT_menqcmd = 2001,                        /* -menqcmd */
  OPT_mf16c = 2002,                          /* -mf16c */
  OPT_mfancy_math_387 = 2003,                /* -mfancy-math-387 */
  OPT_mfentry = 2004,                        /* -mfentry */
  OPT_mfentry_name_ = 2005,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2006,               /* -mfentry-section= */
  OPT_mfix_and_continue = 2007,              /* -mfix-and-continue */
  OPT_mfma = 2008,                           /* -mfma */
  OPT_mfma4 = 2009,                          /* -mfma4 */
  OPT_mforce_drap = 2010,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2011,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2012,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2013,                       /* -mfpmath= */
  OPT_mfsgsbase = 2014,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2015,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2016, */              /* -mfused-madd */
  OPT_mfxsr = 2017,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 2018,             /* -mgeneral-regs-only */
  OPT_mgfni = 2019,                          /* -mgfni */
  OPT_mhard_float = 2020,                    /* -mhard-float */
  OPT_mharden_sls_ = 2021,                   /* -mharden-sls= */
  OPT_mhle = 2022,                           /* -mhle */
  OPT_mhreset = 2023,                        /* -mhreset */
  OPT_miamcu = 2024,                         /* -miamcu */
  OPT_mieee_fp = 2025,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2026,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2027,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2028,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2029,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2030,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2031,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2032,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2033, */            /* -mintel-syntax */
  OPT_mkernel = 2034,                        /* -mkernel */
  OPT_mkl = 2035,                            /* -mkl */
  OPT_mlam_ = 2036,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2037,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2038,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2039,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2040,                /* -mlong-double-80 */
  OPT_mlwp = 2041,                           /* -mlwp */
  OPT_mlzcnt = 2042,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 2043,           /* -mmacosx-version-min= */
  OPT_mmanual_endbr = 2044,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2045,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2046,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2047,                  /* -mmitigate-rop */
  OPT_mmmx = 2048,                           /* -mmmx */
  OPT_mmovbe = 2049,                         /* -mmovbe */
  OPT_mmovdir64b = 2050,                     /* -mmovdir64b */
  OPT_mmovdiri = 2051,                       /* -mmovdiri */
  OPT_mmove_max_ = 2052,                     /* -mmove-max= */
  OPT_mmpx = 2053,                           /* -mmpx */
  OPT_mms_bitfields = 2054,                  /* -mms-bitfields */
  OPT_mmwait = 2055,                         /* -mmwait */
  OPT_mmwaitx = 2056,                        /* -mmwaitx */
  OPT_mneeded = 2057,                        /* -mneeded */
  OPT_mno_align_stringops = 2058,            /* -mno-align-stringops */
  OPT_mno_default = 2059,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2060,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2061,                  /* -mno-push-args */
  OPT_mno_red_zone = 2062,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2063,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2064,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 2065,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 2066,                 /* -mone-byte-bool */
  OPT_mpc32 = 2067,                          /* -mpc32 */
  OPT_mpc64 = 2068,                          /* -mpc64 */
  OPT_mpc80 = 2069,                          /* -mpc80 */
  OPT_mpclmul = 2070,                        /* -mpclmul */
  OPT_mpcommit = 2071,                       /* -mpcommit */
  OPT_mpconfig = 2072,                       /* -mpconfig */
  OPT_mpku = 2073,                           /* -mpku */
  OPT_mpopcnt = 2074,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2075, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2076,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2077,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2078,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2079,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2080,                        /* -mprfchw */
  OPT_mptwrite = 2081,                       /* -mptwrite */
  OPT_mpush_args = 2082,                     /* -mpush-args */
  OPT_mraoint = 2083,                        /* -mraoint */
  OPT_mrdpid = 2084,                         /* -mrdpid */
  OPT_mrdrnd = 2085,                         /* -mrdrnd */
  OPT_mrdseed = 2086,                        /* -mrdseed */
  OPT_mrecip = 2087,                         /* -mrecip */
  OPT_mrecip_ = 2088,                        /* -mrecip= */
  OPT_mrecord_mcount = 2089,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2090,                 /* -mrecord-return */
  OPT_mred_zone = 2091,                      /* -mred-zone */
  OPT_mregparm_ = 2092,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2093,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2094,                           /* -mrtd */
  OPT_mrtm = 2095,                           /* -mrtm */
  OPT_msahf = 2096,                          /* -msahf */
  OPT_mserialize = 2097,                     /* -mserialize */
  OPT_msgx = 2098,                           /* -msgx */
  OPT_msha = 2099,                           /* -msha */
  OPT_mshstk = 2100,                         /* -mshstk */
  OPT_mskip_rax_setup = 2101,                /* -mskip-rax-setup */
  OPT_msoft_float = 2102,                    /* -msoft-float */
  OPT_msse = 2103,                           /* -msse */
  OPT_msse2 = 2104,                          /* -msse2 */
  OPT_msse2avx = 2105,                       /* -msse2avx */
  OPT_msse3 = 2106,                          /* -msse3 */
  OPT_msse4 = 2107,                          /* -msse4 */
  OPT_msse4_1 = 2108,                        /* -msse4.1 */
  OPT_msse4_2 = 2109,                        /* -msse4.2 */
  OPT_msse4a = 2110,                         /* -msse4a */
  /* OPT_msse5 = 2111, */                    /* -msse5 */
  OPT_msseregparm = 2112,                    /* -msseregparm */
  OPT_mssse3 = 2113,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2114,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2115, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2116,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2117, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2118,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2119,                  /* -mstackrealign */
  OPT_mstore_max_ = 2120,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2121,            /* -mstringop-strategy= */
  OPT_mstv = 2122,                           /* -mstv */
  OPT_msymbol_stubs = 2123,                  /* -msymbol-stubs */
  OPT_mtarget_linker = 2124,                 /* -mtarget-linker */
  /* OPT_mtarget_linker_ = 2125, */          /* -mtarget-linker= */
  OPT_mtbm = 2126,                           /* -mtbm */
  OPT_mtls_dialect_ = 2127,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2128,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2129,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2130,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2131,                         /* -mtune= */
  OPT_muintr = 2132,                         /* -muintr */
  OPT_multi_module = 2133,                   /* -multi_module */
  OPT_multiply_defined = 2134,               /* -multiply_defined */
  OPT_multiply_defined_unused = 2135,        /* -multiply_defined_unused */
  OPT_munroll_only_small_loops = 2136,       /* -munroll-only-small-loops */
  OPT_mvaes = 2137,                          /* -mvaes */
  OPT_mveclibabi_ = 2138,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2139,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2140,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2141,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2142,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2143,                      /* -mwbnoinvd */
  OPT_mwidekl = 2144,                        /* -mwidekl */
  OPT_mx32 = 2145,                           /* -mx32 */
  OPT_mxop = 2146,                           /* -mxop */
  OPT_mxsave = 2147,                         /* -mxsave */
  OPT_mxsavec = 2148,                        /* -mxsavec */
  OPT_mxsaveopt = 2149,                      /* -mxsaveopt */
  OPT_mxsaves = 2150,                        /* -mxsaves */
  OPT_n = 2151,                              /* -n */
  OPT_name_sort = 2152,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2153,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2154,              /* -no-integrated-cpp */
  OPT_no_pie = 2155,                         /* -no-pie */
  OPT_no_dead_strip_inits_and_terms = 2156,  /* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 2157,                          /* -nocpp */
  OPT_nodefaultexport = 2158,                /* -nodefaultexport */
  OPT_nodefaultlibs = 2159,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 2160,                /* -nofixprebinding */
  OPT_nolibc = 2161,                         /* -nolibc */
  OPT_nomultidefs = 2162,                    /* -nomultidefs */
  OPT_nophoboslib = 2163,                    /* -nophoboslib */
  OPT_noprebind = 2164,                      /* -noprebind */
  OPT_noseglinkedit = 2165,                  /* -noseglinkedit */
  OPT_nostartfiles = 2166,                   /* -nostartfiles */
  OPT_nostdinc = 2167,                       /* -nostdinc */
  OPT_nostdinc__ = 2168,                     /* -nostdinc++ */
  OPT_nostdlib = 2169,                       /* -nostdlib */
  OPT_nostdlib__ = 2170,                     /* -nostdlib++ */
  OPT_o = 2171,                              /* -o */
  OPT_object = 2172,                         /* -object */
  OPT_objects = 2173,                        /* -objects */
  OPT_p = 2174,                              /* -p */
  OPT_pagezero_size = 2175,                  /* -pagezero_size */
  OPT_pass_exit_codes = 2176,                /* -pass-exit-codes */
  /* OPT_pedantic = 2177, */                 /* -pedantic */
  OPT_pedantic_errors = 2178,                /* -pedantic-errors */
  OPT_pg = 2179,                             /* -pg */
  OPT_pie = 2180,                            /* -pie */
  OPT_pipe = 2181,                           /* -pipe */
  OPT_prebind = 2182,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 2183,   /* -prebind_all_twolevel_modules */
  OPT_preload = 2184,                        /* -preload */
  OPT_print_file_name_ = 2185,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2186,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2187,          /* -print-multi-directory */
  OPT_print_multi_lib = 2188,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2189,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2190,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2191,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2192,               /* -print-prog-name= */
  OPT_print_search_dirs = 2193,              /* -print-search-dirs */
  OPT_print_sysroot = 2194,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2195,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2196,                    /* -print-value */
  OPT_private_bundle = 2197,                 /* -private_bundle */
  OPT_pthread = 2198,                        /* -pthread */
  OPT_quiet = 2199,                          /* -quiet */
  OPT_r = 2200,                              /* -r */
  OPT_rdynamic = 2201,                       /* -rdynamic */
  OPT_read_only_relocs = 2202,               /* -read_only_relocs */
  OPT_remap = 2203,                          /* -remap */
  OPT_reverse_sort = 2204,                   /* -reverse-sort */
  OPT_rpath = 2205,                          /* -rpath */
  OPT_s = 2206,                              /* -s */
  OPT_save_temps = 2207,                     /* -save-temps */
  OPT_save_temps_ = 2208,                    /* -save-temps= */
  OPT_sectalign = 2209,                      /* -sectalign */
  OPT_sectcreate = 2210,                     /* -sectcreate */
  OPT_sectobjectsymbols = 2211,              /* -sectobjectsymbols */
  OPT_sectorder = 2212,                      /* -sectorder */
  OPT_seg1addr = 2213,                       /* -seg1addr */
  OPT_seg_addr_table = 2214,                 /* -seg_addr_table */
  OPT_seg_addr_table_filename = 2215,        /* -seg_addr_table_filename */
  OPT_segaddr = 2216,                        /* -segaddr */
  OPT_segcreate = 2217,                      /* -segcreate */
  OPT_seglinkedit = 2218,                    /* -seglinkedit */
  OPT_segprot = 2219,                        /* -segprot */
  OPT_segs_read_only_addr = 2220,            /* -segs_read_only_addr */
  OPT_segs_read_write_addr = 2221,           /* -segs_read_write_addr */
  OPT_shared = 2222,                         /* -shared */
  OPT_shared_libgcc = 2223,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2224,               /* -shared-libphobos */
  OPT_single_module = 2225,                  /* -single_module */
  OPT_size_sort = 2226,                      /* -size-sort */
  /* OPT_specs = 2227, */                    /* -specs */
  OPT_specs_ = 2228,                         /* -specs= */
  OPT_static = 2229,                         /* -static */
  OPT_static_libasan = 2230,                 /* -static-libasan */
  OPT_static_libgcc = 2231,                  /* -static-libgcc */
  OPT_static_libgfortran = 2232,             /* -static-libgfortran */
  OPT_static_libgm2 = 2233,                  /* -static-libgm2 */
  OPT_static_libgo = 2234,                   /* -static-libgo */
  OPT_static_libhwasan = 2235,               /* -static-libhwasan */
  OPT_static_liblsan = 2236,                 /* -static-liblsan */
  OPT_static_libmpx = 2237,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2238,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2239,               /* -static-libphobos */
  OPT_static_libquadmath = 2240,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2241,               /* -static-libstdc++ */
  OPT_static_libtsan = 2242,                 /* -static-libtsan */
  OPT_static_libubsan = 2243,                /* -static-libubsan */
  OPT_static_pie = 2244,                     /* -static-pie */
  /* OPT_std_c__03 = 2245, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2246, */                /* -std=c++0x */
  OPT_std_c__11 = 2247,                      /* -std=c++11 */
  OPT_std_c__14 = 2248,                      /* -std=c++14 */
  OPT_std_c__17 = 2249,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2250, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2251, */                /* -std=c++1z */
  OPT_std_c__20 = 2252,                      /* -std=c++20 */
  OPT_std_c__23 = 2253,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2254, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2255, */                /* -std=c++2b */
  ...
  OPT_std_c2x = 2261,                        /* -std=c2x */
  /* OPT_std_c89 = 2262, */                  /* -std=c89 */
  OPT_std_c90 = 2263,                        /* -std=c90 */
  OPT_std_c99 = 2264,                        /* -std=c99 */
  /* OPT_std_c9x = 2265, */                  /* -std=c9x */
  OPT_std_f2003 = 2266,                      /* -std=f2003 */
  OPT_std_f2008 = 2267,                      /* -std=f2008 */
  OPT_std_f2008ts = 2268,                    /* -std=f2008ts */
  OPT_std_f2018 = 2269,                      /* -std=f2018 */
  OPT_std_f95 = 2270,                        /* -std=f95 */
  OPT_std_gnu = 2271,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2272, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2273, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2274,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2275,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2276,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2277, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2278, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2279,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2280,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2281, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2282, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2283,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2284,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2285,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2286, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2287, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2288,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2289, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2290,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2291,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2292, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2293, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2294,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2295, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2296, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2297, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2298, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2299, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2300,                     /* -std=legacy */
  OPT_stdlib_ = 2301,                        /* -stdlib= */
  OPT_sub_library = 2302,                    /* -sub_library */
  OPT_sub_umbrella = 2303,                   /* -sub_umbrella */
  OPT_symbol_ = 2304,                        /* -symbol= */
  OPT_symbolic = 2305,                       /* -symbolic */
  OPT_t = 2306,                              /* -t */
  OPT_time = 2307,                           /* -time */
  OPT_time_ = 2308,                          /* -time= */
  OPT_traditional = 2309,                    /* -traditional */
  OPT_traditional_cpp = 2310,                /* -traditional-cpp */
  OPT_tree_stats = 2311,                     /* -tree-stats */
  OPT_trigraphs = 2312,                      /* -trigraphs */
  OPT_twolevel_namespace = 2313,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 2314,       /* -twolevel_namespace_hints */
  OPT_type_stats = 2315,                     /* -type-stats */
  OPT_u = 2316,                              /* -u */
  OPT_umbrella = 2317,                       /* -umbrella */
  OPT_undef = 2318,                          /* -undef */
  OPT_undefined = 2319,                      /* -undefined */
  OPT_unexported_symbols_list = 2320,        /* -unexported_symbols_list */
  OPT_v = 2321,                              /* -v */
  OPT_version = 2322,                        /* -version */
  OPT_w = 2323,                              /* -w */
  OPT_weak_reference_mismatches = 2324,      /* -weak_reference_mismatches */
  OPT_whatsloaded = 2325,                    /* -whatsloaded */
  OPT_whyload = 2326,                        /* -whyload */
  OPT_wrapper = 2327,                        /* -wrapper */
  OPT_x = 2328,                              /* -x */
  OPT_y = 2329,                              /* -y */
  OPT_z = 2330,                              /* -z */
  N_OPTS,
